...
Note that we focus here on the cases we will use to control the asylum device.
There are other call structures that can be done, which will not be covered
by these methods.
"""
