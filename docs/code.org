...
#+begin_src plantuml :file images/experiment_with_script.svg
  skinparam componentStyle rectangle
  skinparam defaultTextAlignment center
  skinparam wrapWidth 200
  skinparam maxMessageSize 200
...
#+begin_src plantuml :file images/afspm_hl_diagram.svg
  skinparam componentStyle rectangle
  skinparam defaultTextAlignment center
  skinparam wrapWidth 200
  skinparam maxMessageSize 200
...
#+begin_src plantuml :file images/network_framework.svg
  skinparam componentStyle rectangle
...
#+begin_src plantuml :file images/afspm_without_afspmcon.svg
  skinparam componentStyle rectangle
  skinparam defaultTextAlignment center
  skinparam wrapWidth 200
  skinparam maxMessageSize 200
...
#+begin_src plantuml :file images/afspm_control.svg
